...
python -u ${INPUT_DIR}/src/exp/extract_astro_data_fasttext.py \
    ...
    --data_dir ${DATASETS_DIR}/dolma_v1_7/CC_news_middle/documents \
    --output_path ${INPUT_DIR}/datasets/astro-cc_news_middle-fasttext.jsonl \
    --threshold 0.95 \
    --skip_files 0 \
    > ${INPUT_DIR}/outputs/astro-cc_news_middle-fasttext.log 2>&1