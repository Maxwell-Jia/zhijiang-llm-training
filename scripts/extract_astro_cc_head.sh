...
python ${INPUT_DIR}/src/exp/extract_astronomy_data.py \
    ...
    --documents_dir ${DATASETS_DIR}/dolma_v1_7/CC_head/documents \
    --output_path ${OUTPUT_DIR}/cc_head-astro-epoch-3.jsonl \
    --similar_threshold 0.4 \
    --max_items 9999999 \
    --gpu 3 \
    --batch_size 4096 \
    > ${INPUT_DIR}/outputs/cc_head-astro-epoch-3.log 2>&1